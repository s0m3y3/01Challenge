# 01 HTML, CSS, and Git: Code Refactoeting agency has hired you to refactor an existing site to make it more accessible. 
r
...
**Refactoring** existing code (improving it without changing what it does) to meet a certain set of standards or to implement a new technology is a common task for front-end and junior developers. For this particular Challenge, a mark
